...
function checkScroll() { //check if the page is scrolled
    if ($(window).scrollTop() >= 300) {//id window is scrolled 300px or more
...
$(document).ready(function(){ //when document(DOM) loads completely
    $('#team-carousel').owlCarousel({ //owlCarousel settings
        ...
        dotSpeed: 1000, //transition speed when using dots/buttons
